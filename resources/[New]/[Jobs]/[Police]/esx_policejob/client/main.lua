...
function OpenCloakroomMenu()
	...
	local elements = {
		...
		{ label = 'Tenue Cadet', value = 'tenu_lspd' },
		{ label = 'Tenue Officier', value = 'tenu_ma' },
		{ label = 'Tenue Moto', value = 'tenu_hiv'},
		{ label = 'Tenue Velo', value = 'tenu_swat'},
		{ label = 'Tenue SWAT ', value = 'tenu_swatgr'},
		{ label = 'Tenue Lieutenant', value = 'tenu_doag' },
		{ label = 'Tenue Capitaine', value = 'tenu_swatinst' },
		{ label = 'Instructeur LSPD', value = 'tenu_lspdinst' },
		{ label = 'Tenue commandant', value = 'tenu_doagr' },
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'cloakroom', {
		...
		if
			...
			data.current.value == 'tenu_doagr' or					
			data.current.value == 'tenu_swatinst' or
			data.current.value == 'tenu_lspdinst' or			
