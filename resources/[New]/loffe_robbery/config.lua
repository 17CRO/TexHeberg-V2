...
Config.Shops = {
    ...
    {coords = vector3(24.03, -1345.63, 29.5-0.98), heading = 266.0, money = {50, 500}, cops = 3, blip = false, name = 'Braquage Superette', cooldown = {hour = 2, minute = 0, second = 0}, robbed = false},
    {coords = vector3(-705.73, -914.91, 19.22-0.98), heading = 91.0, money = {50, 500}, cops = 3, blip = false, name = 'Braquage Superette', cooldown = {hour = 2, minute = 0, second = 0}, robbed = false},
    {coords = vector3(-1221.20, -907.98, 12.32-0.98), heading = 45.0, money = {50, 500}, cops = 3, blip = false, name = 'Braquage Superette', cooldown = {hour = 2, minute = 0, second = 0}, robbed = false},
    {coords = vector3(1134.18, -983.17, 46.41-0.98), heading = 285.0, money = {50, 500}, cops = 3, blip = false, name = 'Braquage Superette', cooldown = {hour = 2, minute = 0, second = 0}, robbed = false},
    {coords = vector3(1165.31, -324.03, 69.20-0.98), heading = 95.0, money = {50, 500}, cops = 3, blip = false, name = 'Braquage Superette', cooldown = {hour = 2, minute = 0, second = 0}, robbed = false},
    {coords = vector3(372.60, 328.35, 103.56-0.98), heading = 250.0, money = {50, 500}, cops = 3, blip = false, name = 'Braquage Superette', cooldown = {hour = 2, minute = 0, second = 0}, robbed = false}
