print("^0======================================================================^7")
print("^0[^4Author^0] ^7:^0 ^5Antonio^7")
...
---------------------------------------------- ITEM Menu DIvers ---------------------------------------------------------------
    ...
    local briquet = NativeUI.CreateItem("~o~menottes ", "Appuyer sur ENTRER pour acheter cette article")
    diversmenu.SubMenu:AddItem(briquet)
    briquet:RightLabel("~r~50$")
    ...
    local sim = NativeUI.CreateItem("~o~Chargeur d'arme", "Appuyer sur ENTRER pour acheter cette article")
    diversmenu.SubMenu:AddItem(sim)
    sim:RightLabel("~r~100$")
 ...
 ---------------------------------------------- Menu Divers ---------------------------------------------------------------
    ...
    diversmenu.SubMenu.OnItemSelect = function(menu, item)
        ...
        elseif item == briquet then 
            ...
            ESX.ShowNotification('Vous avez payé ~r~50$')
            Citizen.Wait(1)
            ESX.ShowAdvancedNotification("Épicier", "Vous avez acheté des ~b~menottes", "", "CHAR_SOCIAL_CLUB", 1)
        ...
        elseif item == sim then
            ...
            Citizen.Wait(1)
            ESX.ShowAdvancedNotification("Épicier", "Vous avez acheté une carte ~b~Charcher d'arme", "", "CHAR_SOCIAL_CLUB", 1)
        end 
