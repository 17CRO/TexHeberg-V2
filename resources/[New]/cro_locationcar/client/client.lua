...
function AddLocationMenu(menu)
    ...
    local panto = NativeUI.CreateItem("Asterope", "Appuyer sur ENTRER pour louer ce véhicule")
...
local blips = {
    {title="Location de Véhicule", colour=3, id = 480, x = -901.96, y = -2343.98, z = 6.16,}
}
